...
var
  ...
  // shotgun
    (ammo: am_radixmisl;         upstate: Ord(S_SGUNUP);    downstate: Ord(S_SGUNDOWN);
     readystate: Ord(S_SGUN);    atkstate: Ord(S_SGUN1);    flashstate: Ord(S_SGUNFLASH1)),
  // chaingun
    (ammo: am_radixshell;        upstate: Ord(S_CHAINUP);   downstate: Ord(S_CHAINDOWN);
  ...
  // bfg 9000
     (ammo: am_radixtorp;        upstate: Ord(S_BFGUP);     downstate: Ord(S_BFGDOWN);
  ...
  // super shotgun
     (ammo: am_radixmisl;        upstate: Ord(S_DSGUNUP);   downstate: Ord(S_DSGUNDOWN);
