...
//
  ...
  // jff 2/26/98 lockout machinery for stairbuilding
    ...
    sky: integer;
    // JVAL: 20200213 - Radix
    radixfloorslope, radixceilingslope: radixslope_t;
    radixheightnodesx: array[0..2] of integer;
    radixheightnodesy: array[0..2] of integer;
    radixfloorheights: array[0..2] of integer;
    radixceilingheights: array[0..2] of integer;
    radixmapXmult: integer;
    radixmapXadd: integer;
