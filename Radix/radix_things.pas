...
const
  ...
  _MTRX_MISSILEBOAT1 = 34; // missile boat (enemy)
  _MTRX_SKYFIREASSULTFIGHTER1 = 35; // skyfire assult fighter (enemy)
  _MTRX_STORMBIRDHEAVYBOMBER = 36; // stormhead heavy bomber (enemy)
  ...
  _MTRX_SKYFIREASSULTFIGHTER2 = 50; // skyfire assult fighter (enemy) LightAssault1.bmp
  ...
  _MTTX_BLOODSPLAT = 89;
  _MTTX_SPARKS = 90;
  _MTTX_RADIXWATERSPLASH = 91;
  _MTTX_RADIXMUDSPLASH = 92;
  _MTTX_RADIXLAVASPLASH = 93;
...
const
  ...
  MT_MISSILEBOAT1 = _DOOM_THING_2_RADIX_ + _MTRX_MISSILEBOAT1;
  MT_SKYFIREASSULTFIGHTER1 = _DOOM_THING_2_RADIX_ + _MTRX_SKYFIREASSULTFIGHTER1;
  ...
  MT_BLOODSPLAT = _DOOM_THING_2_RADIX_ + _MTTX_BLOODSPLAT;
  MT_SPARKS = _DOOM_THING_2_RADIX_ + _MTTX_SPARKS;
  MT_RADIXWATERSPLASH = _DOOM_THING_2_RADIX_ + _MTTX_RADIXWATERSPLASH;
  MT_RADIXMUDSPLASH = _DOOM_THING_2_RADIX_ + _MTTX_RADIXMUDSPLASH;
  MT_RADIXLAVASPLASH = _DOOM_THING_2_RADIX_ + _MTTX_RADIXLAVASPLASH;
