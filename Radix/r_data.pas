...
var
  ...
  approx_white: byte = 128;
  approx_gray: byte = 41;
  approx_orange: byte = 228;
...
begin
  ...
  approx_white := V_FindAproxColorIndex(@cpal, $FFFFFF, 1, 255);
  approx_gray := V_FindAproxColorIndex(@cpal, $808080, 1, 255);
  approx_orange := V_FindAproxColorIndex(@cpal, $FF8080, 1, 255);
