...
const
  singleINFasLongint : longint = $7f800000;   // infinity
  q_singleNANasLongint : longint = $7fC00000; // quiet NAN

var
  singleINF : single absolute singleINFasLongint;
...
begin
  Integer(Result) := scIllegal;
  Integer(FType) := 0;// Initialization
  With FType do begin
