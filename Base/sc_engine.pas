...
type
  ...
  public
    ...
    function GetLongWord: boolean;
    procedure MustGetLongWord;
    ...
    property _LongWord: LongWord read sc_LongWord;
...
//==============================================================================
//
// TScriptEngine.GetLongWord
//
//==============================================================================
function TScriptEngine.GetLongWord: boolean;
var
  code: integer;
begin
  if GetString then
  begin
    val(StringVal(sc_String), sc_LongWord, code);
    if code <> 0 then
    begin
      ScriptError(
          'TScriptEngine.GetLongWord(): Bad numeric constant "%s" at Line %d',
          [sc_String, sc_Line]);
      ScriptPrintLineError(sc_Line, 2);
      result := false;
      exit;
...
//==============================================================================
//
// TScriptEngine.MustGetLongWord
//
//==============================================================================
procedure TScriptEngine.MustGetLongWord;
begin
  if not GetLongWord then
  begin
    ScriptError('TScriptEngine.MustGetLongWord(): Missing LongWord at Line %d', [sc_Line]);
    ScriptPrintLineError(sc_Line, 2);
  end;
end;
